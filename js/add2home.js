...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			de_de: 'Speichere diese Haltestelle: %icon antippen und dann <strong>Zum Home-Bildschirm</strong>.',
			el_gr: 'Εγκαταστήσετε αυτήν την Εφαρμογή στήν συσκευή σας %device: %icon μετά πατάτε <strong>Προσθήκη σε Αφετηρία</strong>.',
			en_us: 'Save this station on your %device: tap %icon and then <strong>Add to Home Screen</strong>.',
